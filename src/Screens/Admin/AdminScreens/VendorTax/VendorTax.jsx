...
function VendorTax() {
    ...
    const apiRes = async (which) => {
        try {
            ...
            const res = await fetch(`${BASE_URL}/vendor/v1/${restaurantId}/tax/list/${which}`, {
                headers: {
    ...
    const handleStatus = async (type, id) => {
        ...
        const restaurantId = sessionStorage.getItem("restaurantId");
        try {
            const res = await fetch(`${BASE_URL}/admin/v1/${restaurantId}/tax/${action}/${id}`, {
                method: "PUT",
                headers: {
                    'Authorization': `Bearer ${token}`,
    ...
    const handleConfirmation = (typ, i) => {
        setType(typ);
        setId(i);
        btnText(true, "cancel", "ok", `Are you sure you want to ${typ} this Vendor Tax ?`);
    };
    const update = async (id, item) => {
        navigation(`/admin/vendorTax/edit/${id}`, { state: item })
    };
            ...
            <div className="w-100" style={{ padding: "30px" }}>
                <div className="section-header d-flex w-100 justify-content-between align-items-center mb-3" style={{ padding: "24px", borderRadius: "20px" }}>
                    ...
                    <div className="d-flex justify-content-start align-items-center gap-3">
                        ...
                        <Link className="btn-download" to="/admin/addVendorTax">
                            <span className="bx"> + Add Tax</span>
                        </Link>
                    </div>
                </div>
                <div className="section-header d-flex w-100 justify-content-between align-items-center mb-3" style={{ padding: "24px", borderRadius: "20px" }}>
                        ...
                        <div class="order" style={{ overflow: "hidden" }}>
                            <div className="products-area-wrapper tableView">
                                <div className="products-header">
                                    ...
                                    <div className="product-cell status-cell">Title<button className="sort-button">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 512 512"><path fill="currentColor" d="M496.1 138.3L375.7 17.9c-7.9-7.9-20.6-7.9-28.5 0L226.9 138.3c-7.9 7.9-7.9 20.6 0 28.5 7.9 7.9 20.6 7.9 28.5 0l85.7-85.7v352.8c0 11.3 9.1 20.4 20.4 20.4 11.3 0 20.4-9.1 20.4-20.4V81.1l85.7 85.7c7.9 7.9 20.6 7.9 28.5 0 7.9-7.8 7.9-20.6 0-28.5zM287.1 347.2c-7.9-7.9-20.6-7.9-28.5 0l-85.7 85.7V80.1c0-11.3-9.1-20.4-20.4-20.4-11.3 0-20.4 9.1-20.4 20.4v352.8l-85.7-85.7c-7.9-7.9-20.6-7.9-28.5 0-7.9 7.9-7.9 20.6 0 28.5l120.4 120.4c7.9 7.9 20.6 7.9 28.5 0l120.4-120.4c7.8-7.9 7.8-20.7-.1-28.5z" /></svg>
                                    </button></div>
                                    <div className="product-cell status-cell">Percentage<button className="sort-button">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 512 512"><path fill="currentColor" d="M496.1 138.3L375.7 17.9c-7.9-7.9-20.6-7.9-28.5 0L226.9 138.3c-7.9 7.9-7.9 20.6 0 28.5 7.9 7.9 20.6 7.9 28.5 0l85.7-85.7v352.8c0 11.3 9.1 20.4 20.4 20.4 11.3 0 20.4-9.1 20.4-20.4V81.1l85.7 85.7c7.9 7.9 20.6 7.9 28.5 0 7.9-7.8 7.9-20.6 0-28.5zM287.1 347.2c-7.9-7.9-20.6-7.9-28.5 0l-85.7 85.7V80.1c0-11.3-9.1-20.4-20.4-20.4-11.3 0-20.4 9.1-20.4 20.4v352.8l-85.7-85.7c-7.9-7.9-20.6-7.9-28.5 0-7.9 7.9-7.9 20.6 0 28.5l120.4 120.4c7.9 7.9 20.6 7.9 28.5 0l120.4-120.4c7.8-7.9 7.8-20.7-.1-28.5z" /></svg>
                                    </button></div>
                                                ...
                                                <div className="product-cell status-cell">
                                                    <span className="cell-label">Status:</span>
                                                    {
                                                        item.active ?
                                                            ...
                                                            <span className={`status ${!item.active && "disabled"}`}>Inactive</span>
                                                    }
                                                </div>
                                                <div className="product-cell action">
                                                    {
                                                        item.active ?
                                                            <span className={`status ${!item.active && "disabled"}`} onClick={() => handleConfirmation("Inactive", item.id)}>Inactive</span> :
